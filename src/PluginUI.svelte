...
<style>
	...
	* {
	...
	.icon--blue {
		-webkit-filter: invert(54%) sepia(16%) saturate(7499%)
			hue-rotate(179deg) brightness(98%) contrast(101%);
		filter: invert(54%) sepia(16%) saturate(7499%) hue-rotate(179deg)
			brightness(98%) contrast(101%);
	}

	.icon--purple {
		-webkit-filter: invert(40%) sepia(59%) saturate(4001%)
			hue-rotate(232deg) brightness(103%) contrast(102%);
		filter: invert(40%) sepia(59%) saturate(4001%) hue-rotate(232deg)
			brightness(103%) contrast(102%);
	}

	.icon--purple4 {
		-webkit-filter: invert(72%) sepia(40%) saturate(660%) hue-rotate(202deg)
			brightness(103%) contrast(103%);
		filter: invert(72%) sepia(40%) saturate(660%) hue-rotate(202deg)
			brightness(103%) contrast(103%);
	}

	.icon--hot-pink {
		-webkit-filter: invert(18%) sepia(90%) saturate(3347%)
			hue-rotate(293deg) brightness(116%) contrast(132%);
		filter: invert(18%) sepia(90%) saturate(3347%) hue-rotate(293deg)
			brightness(116%) contrast(132%);
	}

	.icon--green {
		-webkit-filter: invert(66%) sepia(39%) saturate(5382%)
			hue-rotate(114deg) brightness(102%) contrast(79%);
		filter: invert(66%) sepia(39%) saturate(5382%) hue-rotate(114deg)
			brightness(102%) contrast(79%);
	}

	.icon--red {
		-webkit-filter: invert(43%) sepia(56%) saturate(5632%)
			hue-rotate(349deg) brightness(97%) contrast(95%);
		filter: invert(43%) sepia(56%) saturate(5632%) hue-rotate(349deg)
			brightness(97%) contrast(95%);
	}

	.icon--yellow {
		-webkit-filter: invert(78%) sepia(86%) saturate(1608%) hue-rotate(1deg)
			brightness(107%) contrast(104%);
		filter: invert(78%) sepia(86%) saturate(1608%) hue-rotate(1deg)
			brightness(107%) contrast(104%);
	}

	.icon--black {
		-webkit-filter: invert(0) sepia(0) saturate(7500%) hue-rotate(117deg)
	...
	.icon--black8 {
		-webkit-filter: invert(0) sepia(56%) saturate(25%) hue-rotate(137deg)
			brightness(105%) contrast(60%);
		filter: invert(0) sepia(56%) saturate(25%) hue-rotate(137deg)
			brightness(105%) contrast(60%);
	}

	.icon--black3 {
		-webkit-filter: invert(100%) sepia(0) saturate(698%) hue-rotate(219deg)
			brightness(66%) contrast(127%);
		filter: invert(100%) sepia(0) saturate(698%) hue-rotate(219deg)
			brightness(66%) contrast(127%);
	}

	.icon--white {
		-webkit-filter: invert(100%) sepia(100%) saturate(0) hue-rotate(269deg)
			brightness(103%) contrast(104%);
		filter: invert(100%) sepia(100%) saturate(0) hue-rotate(269deg)
			brightness(103%) contrast(104%);
	}

	.icon--white8 {
		-webkit-filter: invert(99%) sepia(2%) saturate(5%) hue-rotate(55deg)
			brightness(104%) contrast(98%);
		filter: invert(99%) sepia(2%) saturate(5%) hue-rotate(55deg)
			brightness(104%) contrast(98%);
	}

	.icon--white4 {
		-webkit-filter: invert(99%) sepia(2%) saturate(897%) hue-rotate(245deg)
			brightness(117%) contrast(93%);
		filter: invert(99%) sepia(2%) saturate(897%) hue-rotate(245deg)
			brightness(117%) contrast(93%);
	}
	...
	.select-menu__button {
		...
		width: 100%;
		margin: 1px 0 1px 0;
		padding: 0 var(--size-xxsmall) 0 var(--size-xxsmall);
		overflow-y: hidden;
		border-radius: var(--border-radius-small);
		background-color: var(--white);
	}
	...
	.select-menu__item {
		...
		padding: 0 var(--size-xsmall) 0 var(--size-xxsmall);
		-webkit-user-select: none;
		-moz-user-select: none;
		-ms-user-select: none;
		user-select: none;
	...
	.icon--go-to-component {
		background-image: url("data:image/svg+xml,%3Csvg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M5.74279 4.74795L8.00006 2.5L10.2573 4.74795L8.00006 6.9959L5.74279 4.74795ZM4.74819 10.2571L2.50024 7.9998L4.74819 5.74253L6.99614 7.9998L4.74819 10.2571ZM10.2573 11.2517L8.00004 13.4996L5.74278 11.2517L8.00004 9.00371L10.2573 11.2517ZM13.4999 7.99981L11.2519 5.74254L9.00396 7.99981L11.2519 10.2571L13.4999 7.99981Z' fill='black' fill-opacity='0.8'/%3E%3C/svg%3E%0A");
		background-repeat: no-repeat;
	...
	.radio-buttons:hover .icon-button {
		border-radius: 0;
	}

	.radio-button .icon-button {
		border: 1px solid transparent;
		background-clip: padding-box;
	}

	.radio-button input[type="radio"]:checked + .icon-button {
		border-color: rgba(0, 0, 0, 0.1);
	}

	.radio-buttons:hover input[type="radio"] + .icon-button {
		border-top-color: transparent;
		border-bottom-color: transparent;
	}

	.radio-buttons:hover :first-child input[type="radio"] + .icon-button {
		border-left-color: transparent;
	}

	.radio-buttons:hover :last-child input[type="radio"] + .icon-button {
	...
	.radio-button .icon-button:hover {
		background-color: transparent;
	}
	...
	.hover.selected {
		background: rgba(24, 160, 251, 0.45);
	}
	...
	.table-creator-icon {
		background-image: url("data:image/svg+xml,%3Csvg width='172' height='148' viewBox='0 0 172 148' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='172' height='148' fill='white'/%3E%3Cg style='mix-blend-mode:hard-light'%3E%3Cpath d='M128.836 68.7008L128.836 77.6351M127.719 86.3765H136.461C141.395 86.3765 145.395 82.3765 145.395 77.4422V68.7008C145.395 63.7666 141.395 59.7666 136.461 59.7666H127.719C122.785 59.7666 118.785 63.7666 118.785 68.7008V77.4422C118.785 82.3765 122.785 86.3765 127.719 86.3765Z' stroke='url(%23paint0_linear)' stroke-width='4.6278'/%3E%3C/g%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M121.998 39.4349L125.533 35.9141L129.069 39.4349L125.533 42.9558L121.998 39.4349ZM120.437 48.0644L116.916 44.5289L120.437 40.9934L123.958 44.5289L120.437 48.0644ZM129.067 49.623L125.532 53.1438L121.996 49.623L125.532 46.1021L129.067 49.623ZM134.147 44.5303L130.626 40.9948L127.105 44.5303L130.626 48.0658L134.147 44.5303Z' fill='%23F72828'/%3E%3Cpath d='M142.019 49.7761C143.754 49.7761 144.877 48.734 145.035 47.3047H143.644C143.462 48.0982 142.846 48.5667 142.028 48.5667C140.819 48.5667 140.04 47.5581 140.04 45.9566C140.04 44.3839 140.
.5303Z' fill='%23F72828'/%3E%3Cpath d='M78.5761 101.628H80.0054V97.144C80.0054 96.1831 80.7463 95.49 81.7598 95.49C82.0562 95.49 82.3908 95.5426 82.5055 95.576V94.2089C82.3621 94.1898 82.0801 94.1754 81.8984 94.1754C81.0379 94.1754 80.3018 94.663 80.0341 95.4518H79.9576V94.2854H78.5761V101.628ZM86.6397 101.776C88.7095 101.776 90.0624 100.261 90.0624 97.9901C90.0624 95.7051 88.7095 94.1898 86.6397 94.1898C84.5698 94.1898 83.217 95.7051 83.217 97.9901C83.217 100.261 84.5698 101.776 86.6397 101.776ZM86.6444 100.576C85.2916 100.576 84.6606 99.3955 84.6606 97.9853C84.6606 96.5799 85.2916 95.3848 86.6444 95.3848C87.9877 95.3848 88.6187 96.5799 88.6187 97.9853C88.6187 99.3955 87.9877 100.576 86.6444 100.576ZM93.0935 101.628H94.5467L96.0381 96.3266H96.1481L97.6396 101.628H99.0976L101.253 94.2854H99.7764L98.347 99.6537H98.2753L96.8412 94.2854H95.3641L93.9205 99.6776H93.8488L92.4099 94.2854H90.9328L93.0935 101.628Z' fill='%23F72828'/%3E%3Cdefs%3E%3ClinearGradient id='paint0_linear' x1='138.551' y1='77.9474' x2='196.66' y2='140.448' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-color='%23F72828'/%3E%3Cstop offset='1' stop-color='%23FF678C'/%3E%3C/linearGradient%3E%3ClinearGradient id='paint1_linear' x1='35.237' y1='58.3794' x2='55.9641' y2='85.8982' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-color='%23F72828'/%3E%3Cstop offset='1' stop-color='%23FF678C'/%3E%3C/linearGradient%3E%3ClinearGradient id='paint2_linear' x1='35.4273' y1='58.211' x2='83.9213' y2='90.9361' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-color='%23F72828'/%3E%3Cstop offset='1' stop-color='%23FF678C'/%3E%3C/linearGradient%3E%3ClinearGradient id='paint3_linear' x1='79.8629' y1='117.834' x2='87.7848' y2='132.646' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-color='%23F72828'/%3E%3Cstop offset='1' stop-color='%23FF678C'/%3E%3C/linearGradient%3E%3ClinearGradient id='paint4_linear' x1='79.3579' y1='117.783' x2='90.1969' y2='153.011' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-color='%23F72828'/%3E%3Cstop offset='1' stop-color='%23FF678C'/%3E%3C/linearGradient%3E%3C/defs%3E%3C/svg%3E%0A");
		width: 172px;
		height: 148px;
		margin: 0 auto;
		display: block;
	...
	.icon-link {
		background-image: url("data:image/svg+xml,%3Csvg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M8 3.5C8.82843 3.5 9.5 4.17157 9.5 5V6.5H10.25V5C10.25 3.75736 9.24264 2.75 8 2.75C6.75736 2.75 5.75 3.75736 5.75 5V6.5H6.5V5C6.5 4.17157 7.17157 3.5 8 3.5ZM9.5 9.5H10.25V11C10.25 12.2426 9.24264 13.25 8 13.25C6.75736 13.25 5.75 12.2426 5.75 11V9.5H6.5V11C6.5 11.8284 7.17157 12.5 8 12.5C8.82843 12.5 9.5 11.8284 9.5 11V9.5ZM7.625 5.75V10.25H8.375V5.75H7.625Z' fill='black' fill-opacity='0.8'/%3E%3C/svg%3E%0A");
		width: 16px;
		height: 16px;
		display: inline-block;
