...
{#if pageState.chooseRemoteTemplate}
	<div class="container choose-library" style="padding: var(--size-100) var(--size-200)">
		...
		{/if}
		<p class="description">If you can't see your library listed, open the Assets panel and drag an instance of each template onto the canvas.</p>
		<!-- <div class="help">
			<div class="artwork2">
				<div class="svg8"></div>
			</div>
...
{#if pageState.welcomePageActive}
	...
	<div class="container welcomePage" style="padding: var(--size-200)">
		...
		<p>
			Templates can be used with libraries. Simply publish the template and then import it from any of your files.
		</p>
		<div class="buttons">
