...
if (figma.currentPage.getPluginData("includeHeader") == "true") message.includeHeader = true
if (figma.currentPage.getPluginData("includeHeader") == "false") message.includeHeader = false
